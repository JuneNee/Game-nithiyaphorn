...
//ตั้งค่าตัวละครเกม
let playerWidth = 90; //ปรับขนาดตัวละคร
let playerHeight = 90; //ปรับขนาดตัวละคร
let playerX = 50;
...
let boxHeight = 50;
let boxX = 700;
let boxY = 245;//ระดับที่ตัวอุปสรรคอยู่
...
function update() {
    ...
    if(gameOver){ //ตรวจสอบว่าเกมoverหรือเปล่า
        return;
    }
